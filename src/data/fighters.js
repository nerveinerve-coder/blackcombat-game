...
export const FIGHTERS = {
  ...
  웰터급: [
    ...
    f('dongbaek', '동백', '진태호', '12-9-0', '4위', 'S', '11943234', 'webp', false, '웰터급', 185),
    f('koreangangster', '코리안 갱스터', '박원식', '16-9-1', '5위', 'S', '58100688', 'webp', false, '웰터급', 180),
    f('samurai_wel', '사무라이', 'Patrick Kelvin', '9-2-0', '6위', 'S', '34473780', 'webp', false, '웰터급', 178),
    f('viking', 'Viking', 'Lucas Marques', '19-6-0', '7위', 'W', '51523231', 'webp', false, '웰터급', 178),
    f('blackmamba', '블랙맘바', '김율', '9-8-0', '8위', 'S', '11198227', 'webp', false, '웰터급', 185),
    f('nerd', '너드', 'Sander Silva', '4-0-0', '9위', 'G', '40677542', 'webp', false, '웰터급', 186),
    f('kublai', '쿠빌라이', 'Batmunkh Burenzorig', '16-19-0', '10위', 'S', '60298370', 'webp', false, '웰터급', 180),
